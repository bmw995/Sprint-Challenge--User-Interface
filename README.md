...
Smenatic HTML means to give meaning.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
block is as it states a block where inline is in a line
...
it allows you to work independent of others on the same code to allow us to collaborate.
